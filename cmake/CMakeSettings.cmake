...
get_filename_component(STINGRAY_SDK_SOURCE_PATH "../stingray_sdk" REALPATH BASE_DIR "${CMAKE_MODULE_PATH}")
message ("Stingray SDK Path: ${STINGRAY_SDK_SOURCE_PATH}")
...
set(ENGINE_USE_FLOW_NODES_SAMPLE_PLUGIN OFF CACHE BOOL "Enable flow nodes plug-in sample.")
...
if( ENGINE_USE_SOUND AND (PLATFORM_WEBGL OR PLATFORM_UWP) )
...
if( ENGINE_USE_HOLOLENS_PLUGIN AND NOT PLATFORM_UWP )
