...
/* Thread entrypoint callback function. */
...
struct ThreadApi
{
	...
	/* Creates an event for thread signalling. If manual_reset is false, the event will be
...
struct CameraApi
{
	...
	/* Sets the half angles of the specifie camera frustum. */
