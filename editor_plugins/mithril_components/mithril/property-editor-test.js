define([
    ...
    'attributes/core-src'
], function (app, m, props, PropertyEditor, Gradient) {
    'use strict';
    document.title = "Property editor in Js";

    app.controller('propertyController', function ($scope, marshallingService, elementService, projectService, assetService, fileSystemService) {
        ...
        $scope.helperSimpleArgs = props.editor(editorContext, [
            props.category('Vectors', {}, [
                ...
                props.rotation("Rotation Locked", {x: propertyModel('rotationX'),
                    ...
                    increment: 0.5, supportsLock: true})
            ])
        ]);
